...
class SuratJalanController extends Controller
{
  ...
  public function index()
  {
    ...
    $suratjalans->all();
    return view('penjualan.suratJalan.suratJalan', compact('suratjalans'));
  }
  ...
  public function filterData(Request $request)
  {
    ...
    return view('penjualan.suratJalan.suratJalan', compact('suratjalans', 'start', 'end'));
  }
  ...
  public function konfirmasiSuratJalan()
  {
    $suratjalans = suratjalan::join('pelanggans', 'pelanggans.KodePelanggan', '=', 'suratjalans.KodePelanggan')
      ...
      ->get();
    return view('penjualan.suratJalan.konfirmasiSuratJalan', compact('suratjalans'));
  }
  ...
  public function createByCust()
  {
    ...
    return view('penjualan.suratJalan.buatSuratJalan', compact('customers'));
  }
  ...
  {
    $drivers = DB::table('karyawans')->where('Jabatan', 'driver')->get();
    ...
    return view('penjualan.suratJalan.buatSuratJalanAjaxView', compact(
      'pemesananpenjualan',
      'id',
      'pelanggans',
      'lokasis',
  ...
  public function show($id)
  {
    ...
    $items = DB::select(
      "SELECT a.KodeItem,i.NamaItem, a.Qty as jml, i.Keterangan, s.NamaSatuan, k.HargaJual 
    ...
    return view('penjualan.suratJalan.showSuratJalan', compact('id', 'suratjalan', 'driver', 'matauang', 'lokasi', 'pelanggan', 'items'));
  }
  ...
  public function confirm($id)
  {
    ...
    $checkitem = DB::select("SELECT a.KodeItem, i.NamaItem, i.Keterangan, s.NamaSatuan, k.HargaJual,
      COALESCE(a.qty,0)-COALESCE(SUM(sjd.qty),0) as jml
      FROM pemesanan_penjualan_detail a 
      inner join items i on a.KodeItem = i.KodeItem
      inner join itemkonversis k on i.KodeItem = k.KodeItem
      ...
      left join suratjalans sj on sj.KodeSO = a.KodeSO
      left join suratjalandetails sjd on sjd.KodeSuratJalan = sj.KodeSuratJalan and sjd.KodeItem = a.KodeItem and sjd.KodeSatuan = k.KodeSatuan
      where a.KodeSO='" . $so['KodeSO'] . "' and a.KodeSatuan = k.KodeSatuan
      group by a.KodeItem, s.NamaSatuan
      having jml > 0");
  ...
  public function view($id)
  {
    ...
    return view('penjualan.suratJalan.viewSuratJalan', compact('id', 'suratjalan', 'driver', 'matauang', 'lokasi', 'pelanggan', 'items'));
  }
  ...
  public function print($id)
  {
    ...
    //         a.Subtotal, b.Keterangan  from suratjalandetails a
