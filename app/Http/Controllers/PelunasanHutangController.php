...
class PelunasanHutangController extends Controller
{
    ...
    {
        $invoice = DB::select("SELECT i.KodeInvoiceHutangShow, i.KodeInvoiceHutang, p.NamaSupplier, i.Tanggal, i.Term, d.KodeLPB, d.Subtotal, d.TotalReturn, i.Status, COALESCE(sum(pp.Jumlah),0) as bayar 
