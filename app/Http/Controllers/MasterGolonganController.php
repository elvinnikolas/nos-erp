...
class MasterGolonganController extends Controller
{
    ...
    {
        /*$last = DB::table('new_golongan')->orderBy('NoGolongan', 'desc')->take(1)->value('NoGolongan');
        if (empty($last)) {
            $last = 0;
        }*/
    ...
    public function store(Request $request)
    {
        ...
        $result = golongan::setGolongan($request->all());
    ...
    {
        $namaGolongan = DB::table('new_golongan')->where('NoGolongan', $id)->value('NamaGolongan');
        golongan::deleteGolongan($id);
        $pesan = 'Data Golongan ' . $namaGolongan . ' telah dihapus';
    ...
    public function apiOPN(Request $request)
    {
        $data = golongan::getGolongan($request->id);
