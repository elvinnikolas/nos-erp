...
class PelunasanPiutangController extends Controller
{
    ...
    {
        $invoice = DB::select("SELECT i.KodeInvoicePiutangShow, i.KodeInvoicePiutang, p.NamaPelanggan, i.Tanggal, i.Term, d.KodeSuratJalan, d.Subtotal, d.TotalReturn, i.Status, COALESCE(sum(pp.Jumlah),0) as bayar 
