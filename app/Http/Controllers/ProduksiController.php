...
class ProduksiController extends Controller
{
    ...
    public function create()
    {
        ...
        $golongan = DB::table('new_golongan')
            ->join('new_golongangroupitem', 'new_golongangroupitem.NoGolongan', '=', 'new_golongan.NoGolongan')
            ->where('new_golongan.Status', 'OPN')
            ->get();
        ...
        return view('produksi.hasil.create', compact('kode_produksi', 'resep', 'karyawan', 'satuan', 'golongan'));
    }
