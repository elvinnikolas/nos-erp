...
class KartuStokController extends Controller
{
    ...
    {
        // $stok = DB::select("SELECT a.Tanggal, a.KodeItem, a.KodeLokasi, a.JenisTransaksi, a.KodeTransaksi, round((a.Qty/min(c.Konversi)),4) as Qty, a.KodeUser, round((a.Saldo/min(c.Konversi)),4) as saldo, l.NamaLokasi, i.NamaItem, s.NamaSatuan
        $stok = DB::select("SELECT a.Tanggal, a.KodeItem, a.KodeLokasi, a.JenisTransaksi, a.KodeTransaksi, round((a.Qty/min(c.Konversi)),4) as Qty, a.KodeUser, round(a.saldo/min(c.Konversi),4) as saldo, l.NamaLokasi, i.NamaItem, s.NamaSatuan
            from keluarmasukbarangs a 
            inner join lokasis l on a.KodeLokasi = l.KodeLokasi 
            inner join items i on a.KodeItem = i.KodeItem
    ...
    {
        $stok = DB::select("SELECT a.Tanggal, a.KodeItem, a.KodeLokasi, a.JenisTransaksi, a.KodeTransaksi, round((a.Qty/c.Konversi),4) as Qty, a.KodeUser, round(a.saldo/c.Konversi,4) as saldo, l.NamaLokasi, i.NamaItem, s.NamaSatuan
            from keluarmasukbarangs a 
            inner join lokasis l on a.KodeLokasi = l.KodeLokasi 
            inner join items i on a.KodeItem = i.KodeItem    
            left join keluarmasukbarangs b on a.KodeItem = b.KodeItem and b.created_at <= a.created_at
