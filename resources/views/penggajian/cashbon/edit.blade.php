    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                ...
                <div class="x_body">
                    <div class="row">
                        <form action="{{ url('/penggajiancashbon/update',$cashbon->KodeCashbon) }}" method="post">
                            @csrf
                            <div class="form-group">
                                <div class="control-label col-md-3">
                                    <label for="inputDate">Tanggal</label>
                                    <div class="input-group date" id="inputDate">
                                        <input type="text" class="form-control" name="Tanggal" value="{{$cashbon->Tanggal}}" required>
                                ...
                                <div class="control-label col-md-3" style="display: inline">
                                    ...
                                    <div class="input-group" id="inputTotalSetoran">
                                        <input type="text" class="form-control setoran" name="TotalSetoran" value="{{$cashbon->TotalSetoran}}" required onchange="input_setoran()">
                                ...
                                <div class="control-label col-md-3">
                                    ...
                                    <div class="input-group" id="inputTotalCashbon">
                                        <input readonly type="hidden" class="form-control total" name="TotalCashbon" value="{{$cashbon->TotalCashbon}}">
                                ...
                                <div class="control-label col-md-12">
                                    <table class="table table-bordered" id="tableKaryawan">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$data->Nama}}</td>
                                                <td><input class="form-control nominal{{$key+1}}" onchange="input_nominal({{$key+1}})" type="number" name="Nominal[]" placeholder="0" value="{{$data->Nominal}}"></td>
                                                <td><input readonly type="text" class="form-control nominalshow{{$key+1}}" value="Rp. {{$data->Nominal ? $data->Nominal : 0}},-"></td>
