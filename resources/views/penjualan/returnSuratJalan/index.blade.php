            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{ url('/returnSuratJalan/destroy/'.$suratjalanreturn->KodeSuratJalanReturnID) }}" class="btn-xs btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
