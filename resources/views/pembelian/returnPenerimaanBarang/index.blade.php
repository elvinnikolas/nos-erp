                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('/returnPenerimaanBarang/destroy/'.$penerimaanbarangreturn->KodePenerimaanBarangReturn) }}" class="btn-xs btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
