        ...
        <div class="x_content">
          <table class="table table-light" id="table">
            ...
            <tr>
              ...
              <td>
                <a href="{{ url('/popembelian/confirm/'.$p->KodePO)}}" class="btn-xs btn btn-info" onclick="return confirm('Konfirmasi data ini?')">
                  <i class="fa fa-check" aria-hidden="true"></i>
                </a>
                <a href="{{ url('/popembelian/show/'. $p->KodePO )}}" class="btn-xs btn btn-primary">
                  <i class="fa fa-eye" aria-hidden="true"></i> Lihat
                </a>
                <a href="{{ url('/popembelian/edit/'. $p->KodePO )}}" class="btn-xs btn btn-success">
