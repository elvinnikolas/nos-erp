      ...
      <table class="table table-light table-striped" id="tpenerimaanbarang">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ url('/penerimaanBarang/confirm/'.$penerimaanbarang->KodePenerimaanBarang)}}" class="btn-xs btn btn-info" onclick="return confirm('Konfirmasi data ini?')">
                <i class="fa fa-check" aria-hidden="true"></i>
              </a>
              <a href="{{ url('/penerimaanBarang/show/'.$penerimaanbarang->KodePenerimaanBarang) }}" class="btn-xs btn btn-primary">
                <i class="fa fa-eye" aria-hidden="true"></i> Lihat
              </a>
              <a href="{{ url('penerimaanBarang/edit/'.$penerimaanbarang->KodePenerimaanBarang)}}" class="btn btn-xs btn-success">
                <i class="fa fa-pencil" aria-hidden="true"></i> Ubah
              </a>
              <a href="{{ url('/penerimaanBarang/destroy/'.$penerimaanbarang->KodePenerimaanBarang)}}" class="btn-xs btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
