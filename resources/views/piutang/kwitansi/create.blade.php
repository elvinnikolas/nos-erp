    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="{{ url('/kwitansipiutang/store') }}" method="post" class="formsub">
                        @csrf
                        <!-- Contents -->
                        <br>
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="NamaTtd" placeholder="Nama" required value="Andreas Leksono">
                                </div>
                                <div class="form-group">
                                    <label>Kota (ttd kwitansi)</label>
                                    <input type="text" class="form-control" name="KotaTtd" placeholder="Kota" required value="Malang">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                <div class="form-group">
                                    <label for="alamat">Alamat (pelanggan di kwitansi)</label>
                                    <select name="Alamat" class="form-control" id="alamat">
                                        @foreach($alamat as $alm)
                                        <option name="Alamat" value="{{$alm->AlamatInvoice}}">{{$alm->AlamatInvoice}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="kota">Kota (pelanggan di kwitansi)</label>
                                    <select name="Kota" class="form-control" id="kota">
                                        @foreach($alamat as $alm)
                                        <option name="Kota" value="{{$alm->KotaInvoice}}">{{$alm->KotaInvoice}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
